...
class HeroPlane(BasePlane):
	def __init__(self, screen, image="./feiji/hero.png"):
		super().__init__(screen, SCREEN_WIDTH/2-50, SCREEN_HEIGHT-130, image)
...
class EnermyPlane(BasePlane):
	def __init__(self, screen):
		...
		self.bullets = []
		super().__init__(screen, 250, 0, "./feiji/enemy.png")
...
class EnermyBullet(BaseBullet):
	def __init__(self, screen, x, y):
		super().__init__(screen, x, y, "./feiji/bullet2.png")
...
def main():
	...
	while True:
		...
		if enermy.is_hit:
			enermy_nums += 1
			if enermy_nums == 10:
				enermy.image = pygame.image.load("./feiji/enemy1_down1.png")
			elif enermy_nums == 20:
				enermy.image = pygame.image.load("./feiji/enemy1_down2.png")
			elif enermy_nums == 30:
				enermy.image = pygame.image.load("./feiji/enemy1_down3.png")
			elif enermy_nums == 40:
				enermy.image = pygame.image.load("./feiji/enemy1_down4.png")
			elif enermy_nums > 50:
				enermy = EnermyPlane(screen)
				enermy_nums = 0
		else:
